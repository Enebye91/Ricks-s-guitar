...
export default class View {
    constructor(controller) {
        ...
        snSearchForm.onsubmit = function (e) {
            e.preventDefault(); 
            console.log(snfield.value)
            self.controller.snSearch(snfield.value); // her tager controlleren over
        } // her fortæller Javascript at den ikke skal reloade siden, men holde fast. 

        
        searchForm.onsubmit = function (e) {
            e.preventDefault(); 
            const optimalGuitar = new Guitar ("", price.value, builder.value, model.value, type.value,
            backwood.value, topwood.value); 
